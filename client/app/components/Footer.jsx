        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="https://www.instagram.com/im_shafiqurrehman" className="text-base text-black dark:text-gray-300 dark:hover:text-white">Instagram</Link>
              </li>
              <li>
                <Link href="https://github.com/im-shafiqurrehman" className="text-base text-black dark:text-gray-300 dark:hover:text-white">GitHub</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">Call In: +92 3264139439</p>
            <p className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">Address: #######</p>
            <p className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">Mail Us: shafiqurrehmanbscs2022.com</p>
          </div>
        </div>
