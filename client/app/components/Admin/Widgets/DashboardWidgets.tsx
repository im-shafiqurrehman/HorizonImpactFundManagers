...
const CircularProgressWithLabel: FC<Props> = ({ open = false, value = 0 }) => {
  return (
...
const DashboardWidgets: FC<Props> = ({ open = false }) => {
  ...
  useEffect(() => {
    ...
    if (userData?.user?.last12Months && orderData?.orders?.last12Months) {
      const userLastTwoMonths = userData.user.last12Months.slice(-2);
    ...
    <div className="mt-[30px] min-h-screen">
      <div className="grid grid-cols-[75%,25%]">
        ...
        <div className="pt-[80px] pr-8">
            ...
            <div className="flex items-center p-5 justify-between">
              <div>
                ...
                <h5 className="pt-2 font-Poppins dark:text-[#fff] text-black text-[20px]">
                  {ordersComparePercentage?.currentMonth ?? "N/A"}
                </h5>
              ...
              <div>
                <CircularProgressWithLabel
                  value={
                    ordersComparePercentage?.percentChange && ordersComparePercentage?.percentChange > 0
                      ? 100
                      : 0
                  }
                  open={open}
                ...
                <h5 className="text-center pt-4">
                  {ordersComparePercentage?.percentChange != null
          ...
          {/* New Users Card */}
          <div className="w-full dark:bg-[#111C43] bg-white rounded-sm shadow my-8">
            <div className="flex items-center p-5 justify-between">
              <div>
                <PiUsersFourLight className="dark:text-[#45CBA0] text-[#000] text-[30px]" />
                <h5 className="pt-2 font-Poppins dark:text-[#fff] text-black text-[20px]">
                  {userComparePercentage?.currentMonth ?? "N/A"}
                </h5>
                <h5 className="py-2 font-Poppins dark:text-[#45CBA0] text-black text-[20px] font-[400]">
                  New Users
                </h5>
              ...
              <div>
                <CircularProgressWithLabel
                  value={
                    userComparePercentage?.percentChange && userComparePercentage?.percentChange > 0
                      ? 100
                      : 0
                  }
                  open={open}
                />
                <h5 className="text-center pt-4">
                  {userComparePercentage?.percentChange != null
      ...
      <div className="grid grid-cols-[65%,35%] mt-[-20px]">
        <div className="dark:bg-[#111c43] bg-white w-[94%] mt-[30px] h-[40vh] shadow-sm m-auto">
