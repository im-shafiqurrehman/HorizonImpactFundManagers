...
const EditHero = (props: Props) => {
  ...
  const { data, refetch, isLoading: isDataLoading } = useGetHeroDataQuery("Banner", {
    refetchOnMountOrArgChange: true,
  });
  const [editLayout, { isLoading: isEditLoading, isSuccess, error }] = useEditLayoutMutation();
  ...
  useEffect(() => {
    ...
    if (error) {
      if ("data" in error) {
        ...
        toast.error(errorData?.data?.message || "An error occurred while updating");
      }
    }
