...
interface itemProps {
    ...
    selected: string;
    setSelected: React.Dispatch<React.SetStateAction<string>>;  // More specific type for setSelected
  }
...
const Item: React.FC<itemProps> = ({
  ...
  return (
    <MenuItem
      ...
      icon={icon}
      className={`${
        selected === title ? "bg-blue-100 dark:bg-blue-900" : ""
            ...
            {!isCollapsed && (
              ...
              >
                <Link href="/">
                  <Typography
                    variant="h5"
                    className="!text-xl font-bold uppercase dark:text-white text-black"
                  >
                    ELearning
                  </Typography>
                </Link>
