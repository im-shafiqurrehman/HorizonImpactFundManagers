  ...
  return (
    <div className="w-[65%] sm:w-[75%] max-w-[320px] mx-auto px-2 py-4 rounded-xl border border-gray-200 shadow-[0_2px_10px_rgba(0,0,0,0.07)]">
      ...
      <div className="w-full flex justify-center mt-6">
        <button
          className="w-full bg-[#e9844c] text-white font-medium py-2 rounded-md hover:bg-[#e9844c]/90 transition-colors"
      ...
      <p className="text-center text-[12px] sm:text-[16px] text-[#545454] mt-4">
        Go back to Sign in?{" "}
        <span
