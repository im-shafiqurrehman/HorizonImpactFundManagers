...
const Forgetpasswordotp: FC<Props> = ({ setRoute, setOpen, refetch }) => {
  ...
  return (
    <div className="w-full">
      ...
      <h1>{otpVerified ? "Reset Password" : "Verify Email"}</h1>
        ...
        <form onSubmit={handleVerifyOtp}>
          ...
          <div className="w-full mt-6">
            <input
              ...
              className={`hover:bg-[#0b4b8b] ${isVerifying ? "opacity-70 cursor-not-allowed" : ""}`}
            />
          </div>
        </form>
      ) : (
        <form onSubmit={handleResetPassword}>
          ...
          <div className="w-full mt-6">
            <input
              ...
              className={`hover:bg-[#0b4b8b] ${isResetting ? "opacity-70 cursor-not-allowed" : ""}`}
            />
          </div>
        </form>
      )}
