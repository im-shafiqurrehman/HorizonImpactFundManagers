...
const Signup: FC<Props> = ({ setRoute }) => {
  ...
  return (
    <div className="w-full flex justify-center items-center bg-transparent">
      <div className="w-[65%] sm:w-[95%] max-w-[420px] mx-auto px-2 py-4 rounded-xl border border-gray-200 shadow-[0_2px_10px_rgba(0,0,0,0.07)] bg-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-[#e9844c] text-white font-medium py-2 rounded-md mt-4">
            Sign Up
          </button>
